...
sub createTar()
{
  ...
  if($coreproject =~ /linAS5/)
  {
  	...
  	print "ms-$mrnumber-$hostos-build$build_number\.tar\.gz => $destination/$hostplatform/NotTested/ms-$mrnumber-$hostos-build$build_number\_$dtformat\.tar\.gz";
  	copy("ms-$mrnumber-$hostos-build$build_number\.tar\.gz","$destination/$hostplatform/NotTested/ms-$mrnumber-$hostos-build$build_number\_$dtformat\.tar\.gz") or die("Couldn't copy to destination $!");
	...
	elsif($coreproject =~ /sol10/)
	{
  	...
  	copy("ms-$mrnumber-$hostplatform-build$build_number\.tar\.gz","$destination/$hostplatform/NotTested/ms-$mrnumber-$hostplatform-build$build_number\_$dtformat\.tar\.gz") or die("Couldn't copy to destination $!");
  	push(@location,"$destination/$hostplatform/NotTested/ms-$mrnumber-$hostplatform-build$build_number\_$dtformat\.tar\.gz");
  	print LOCATION "$destination/$hostplatform/NotTested/ms-$mrnumber-$hostplatform-build$build_number\_$dtformat\.tar\.gz \n";
	}
